...
export function ServiceCard({ icon = "shield", title, description, features = [], href, cta = "Learn more", style }) {
  return <Card interactive href={href} style={style}>
    ...
    <p style={{ margin: 0, color: "var(--text-secondary)", lineHeight: "var(--leading-body)" }}>{description}</p>
