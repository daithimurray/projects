...
export function Card({ children, padding = 24, interactive = false, href, onClick, tone = "default", media, style }) {
  ...
  return <Comp href={href} onClick={onClick} type={Comp === "button" ? "button" : undefined} {...(interactive ? it.handlers : {})}
