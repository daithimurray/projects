export const D = {
  services: [
    ...
    { icon: 'grid', title: 'Resin bound preparation', description: 'We prepare the base; partner contractors Redlough and Saxa Landscapes lay the resin finish.', meta: ['With trusted partners'] }
  ],
  projects: [
    { title: 'Tarmac driveway, Castleknock', location: 'Castleknock, Dublin 15', duration: 'Driveway', category: 'Driveway' },
    { title: 'Farm avenue, Straffan', location: 'Straffan, Co. Kildare', duration: 'Avenue', category: 'Roadway' },
    { title: 'Private roadway, Howth', location: 'Howth, Co. Dublin', duration: 'Roadway', category: 'Roadway' },
    { title: 'Driveway with kerbing, Suncroft', location: 'Suncroft, Co. Kildare', duration: 'Driveway', category: 'Driveway' },
    { title: 'Footpath, Donnybrook', location: 'Donnybrook, Dublin 4', duration: 'Footpath', category: 'Commercial' },
    { title: 'Roadway and path, Portrane', location: 'Portrane, Co. Dublin', duration: 'Roadway & path', category: 'Roadway' },
    { title: 'Resin base, garden, Leixlip', location: 'Leixlip, Co. Kildare', duration: 'Resin preparation', category: 'Driveway' },
    { title: 'Powerwash and reseal, Cherrywood', location: 'Cherrywood, Dublin 18', duration: 'Reseal', category: 'Repair' },
    { title: 'Driveway, Kilcloon', location: 'Kilcloon, Co. Meath', duration: 'Driveway', category: 'Driveway' }
  ],
  reviews: [
  ...
  footerCols: [
    { title: 'Services', links: [{ label: 'Tarmac driveways', href: '#services' }, { label: 'Commercial car parks & roadways', href: '#services' }, { label: 'Schools & playgrounds', href: '#services' }, { label: 'Kerbing & groundworks', href: '#services' }, { label: 'Pothole repair', href: '#services' }, { label: 'Powerwash & reseal', href: '#services' }] },
    { title: 'Company', links: [{ label: 'About', href: '#about' }, { label: 'Projects', href: '#projects' }, { label: 'Areas we cover', href: '#faq' }, { label: 'Contact', href: '#quote' }] }
  ]
};
